...
#include "obj_dir_IntMulBase_noparam/VIntMulBase_noparam.h"
#include "stdio.h"
#include "stdint.h"
#include "verilated.h"
...
#if VLINETRACE
#include "obj_dir_IntMulBase_noparam/VIntMulBase_noparam__Syms.h"
#include "svdpi.h"
#endif
...
extern "C" {
  ...
  } VIntMulBase_noparam_t;

  // Exposed methods
  VIntMulBase_noparam_t * VIntMulBase_noparam_create_model( const char * );
  void VIntMulBase_noparam_destroy_model( VIntMulBase_noparam_t *);
  void VIntMulBase_noparam_comb_eval( VIntMulBase_noparam_t * );
  void VIntMulBase_noparam_seq_eval( VIntMulBase_noparam_t * );
  void VIntMulBase_noparam_assert_on( VIntMulBase_noparam_t *, bool );
  bool VIntMulBase_noparam_has_assert_fired( VIntMulBase_noparam_t * );

  #if VLINETRACE
  void VIntMulBase_noparam_line_trace( VIntMulBase_noparam_t *, char * );
  #endif
...
VIntMulBase_noparam_t * VIntMulBase_noparam_create_model( const char *vcd_filename ) {

  VIntMulBase_noparam_t  * m;
  VIntMulBase_noparam * model;
  ...
  m     = new VIntMulBase_noparam_t;
  model = new VIntMulBase_noparam(context_ptr);
...
void VIntMulBase_noparam_destroy_model( VIntMulBase_noparam_t * m ) {

  #if VM_COVERAGE
    VerilatedCov::write( "coverage.dat" );
  #endif

  VIntMulBase_noparam * model = (VIntMulBase_noparam *) m->_cffi_model;
...
void VIntMulBase_noparam_comb_eval( VIntMulBase_noparam_t * m ) {
...
void VIntMulBase_noparam_seq_eval( VIntMulBase_noparam_t * m ) {
...
void VIntMulBase_noparam_assert_on( VIntMulBase_noparam_t * m, bool enable ) {
...
bool VIntMulBase_noparam_has_assert_fired( VIntMulBase_noparam_t * m ) {
...
#if VLINETRACE
void VIntMulBase_noparam_line_trace( VIntMulBase_noparam_t * m, char* str ) {
  ...
  // which is called `v`.
  // svSetScope( &model->__VlSymsp->__Vscope_IntMulBase_noparam__v );
  ...
  const svScope dut_scope = svGetScopeFromName("TOP.IntMulBase_noparam.v");
  assert( dut_scope );
  svSetScope( dut_scope );

  VIntMulBase_noparam::line_trace( words );
